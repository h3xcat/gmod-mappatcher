...
function PANEL:Init()
    ...
    local mappatcher_menu_title = (language.GetPhrase("#mappatcher_menu_title"))
    ...
    function title_panel:Paint( w, h)
        ...
        surface.DrawText( mappatcher_menu_title.."2.4.1" )
    end
    ...
    submit_button:SetText( "#mappatcher_menu_submit_changes" )
    ...
    remove_button:SetText( "#mappatcher_menu_remove_object" )
