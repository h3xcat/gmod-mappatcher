...
local mappatcher_hud_display_mappatcher_menu = (language.GetPhrase("#mappatcher_hud_display_mappatcher_menu"))
local mappatcher_hud_exit = (language.GetPhrase("#mappatcher_hud_exit"))
...
function PANEL:Paint( w, h )
    ...
    surface.DrawText( "#mappatcher_hud_title" )
    ...
    surface.DrawText( "#mappatcher_hud_select_object" )
    surface.SetTextPos( 65, 160 )
    surface.DrawText( "#mappatcher_hud_select_object_help" )
    surface.SetTextPos( 65, 180 )
    surface.DrawText( "#mappatcher_hud_create_point" )
    surface.SetTextPos( 65, 200 )
    surface.DrawText( "["..menu_key_name.."]"..mappatcher_hud_display_mappatcher_menu )
    surface.SetTextPos( 65, 220 )
    surface.DrawText( "#mappatcher_hud_change_point_distance" )
