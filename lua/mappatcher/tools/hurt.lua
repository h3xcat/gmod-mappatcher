...
function TOOL:SetupObjectPanel( panel )
    ...
    numTimeBeforeHurt:SetText( "#mp_hurt_time_before_hurt" )
    ...
    numHurtInterval:SetText( "#mp_hurt_interval" )
    ...
    numHurtAmount:SetText( "#mp_hurt_amount" )
    ...
    lblDamageType:SetText( "#mp_hurt_damage_type" )

    local cmbDamageType = vgui.Create( "DComboBox", panel )
    cmbDamageType:SetPos( 137, 85 )
    cmbDamageType:SetSize( 123, 20 )
    cmbDamageType:AddChoice( "#mp_hurt_damage_generic", DMG_GENERIC, self.damage_type == DMG_GENERIC )
    cmbDamageType:AddChoice( "#mp_hurt_damage_poison", DMG_POISON, self.damage_type == DMG_POISON )
    cmbDamageType:AddChoice( "#mp_hurt_damage_dissolve", DMG_DISSOLVE, self.damage_type == DMG_DISSOLVE )
